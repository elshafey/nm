...
<div class="book-code">                     
    <div class="fb-area">
        <div id="fb_share_1" style="margin-top: 1px;">
            ...
            <div class="fb-like" data-href="<?php echo (get_routed_url(Urls::URL_PREFIX_BOOK. $book['id'])) ?>" data-send="true" data-layout="box_count" data-width="100" data-show-faces="true"></div>
        </div>                            
    </div>
    <div >
