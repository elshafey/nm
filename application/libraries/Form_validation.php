...
class My_Form_validation {
    ...
    function error($field = '', $prefix = '', $suffix = '') {
        ...
        if ($field == 'js_admission_date') {
//                    pre_print($prefix);
//                    pre_print(explode(">", $prefix));
            $prefix = implode('hash="' . $field . '"', explode(">", $prefix)) . ">";
//                    echo $prefix;
//                    exit;
        }
    ...
    public function select($str, $defaultValue = '') {

        if ($defaultValue != '' && $str == $defaultValue)
            return false;
    ...
    /**
     * Check if count of the passed $param Array not exceed the $max value
     * 
     * @param array $param
     * @param int $max
     * @return boolean 
     */
    function max_count($param, $max = 1) {
        if (!is_array($param))
            return false;
    ...
    /**
     * Check if count of the passed $param Array not less than the $max value
     * 
     * @param array $param
     * @param int $min
     * @return boolean 
     */
    function min_count($param, $min = 0) {
        if (!is_array($param))
            return false;
